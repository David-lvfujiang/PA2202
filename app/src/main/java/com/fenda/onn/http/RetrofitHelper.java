...
import com.fenda.onn.BuildConfig;
import com.fenda.onn.config.Constant;
import com.fenda.onn.utils.SPUtils;
...
public class RetrofitHelper {
     ...
     * 请求拦截器
     */
    private class ReqInterceptor implements Interceptor {
        @Override
        public Response intercept(Chain chain) throws IOException {
            String cookie = (String) SPUtils.get(AppApplication.getContext(), Constant.SP.COOKIE, "");
            Request request = chain.request()
                    .newBuilder()
    ...
    private class RespInterceptor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!cookieList.isEmpty()) {
                ...
                SPUtils.put(AppApplication.getContext(), Constant.SP.COOKIE, builder.toString());
            }
            return response;
        }
    }
