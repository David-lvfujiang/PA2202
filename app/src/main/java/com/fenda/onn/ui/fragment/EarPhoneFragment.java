...
public class EarPhoneFragment extends BaseFragment {
    ...
    public int onBindLayout() {
        return R.layout.fragment_ear_series;
    }
    ...
    protected void initData() {
        ...
        ProductionSeriesBean bean1 = new ProductionSeriesBean(R.mipmap.pic_party, mContext.getString(R.string.indoor_speaker));
        ProductionSeriesBean bean2 = new ProductionSeriesBean(R.mipmap.pic_indoor, mContext.getString(R.string.rugged_speaker));
        mDatas.add(bean1);
        mDatas.add(bean2);
